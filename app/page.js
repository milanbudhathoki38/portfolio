          ...
          <div className="flex flex-col" style={{ gap: '24px' }}>
            ...
            <div className="rounded-2xl" style={{ background: '#f9fafb', padding: '32px' }}>
              <div className="flex justify-between items-start" style={{ marginBottom: '8px' }}>
                ...
                <span className="text-sm text-gray-400" style={{ whiteSpace: 'nowrap', marginLeft: '12px' }}>Jan 2025 – Jul 2025</span>
              </div>
            ...
            <div className="rounded-2xl" style={{ background: '#f9fafb', padding: '32px' }}>
              <div className="flex justify-between items-start" style={{ marginBottom: '8px' }}>
                ...
                <span className="text-sm text-gray-400" style={{ whiteSpace: 'nowrap', marginLeft: '12px' }}>Aug 2024 – May 2025</span>
              </div>
              <a href="https://www.lyon.edu" target="_blank" style={{ fontSize: '14px', color: '#2563eb', marginBottom: '16px', display: 'block', textDecoration: 'none' }}>Lyon College →</a>
              <ul className="flex flex-col" style={{ gap: '8px' }}>
        ...
        <section id="contact" style={{ padding: '20px 0' }}>
          ...
          <div style={{ maxWidth: '560px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <input
              ...
              style={{ width: '100%', padding: '12px 16px', borderRadius: '8px', border: '1px solid #e5e7eb', fontSize: '15px', outline: 'none', fontFamily: 'Inter, sans-serif', boxSizing: 'border-box' }}
            />
            <input
              type="email"
